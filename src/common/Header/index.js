                    ...
                    <div className="wrap">
                        <div className="white-box clearfix">
                            <ul>
                                ...
                                <li className={this.isActive('rooms') ? 'active' : null} onClick={this.toggleClass.bind(this, 1)}>
                                    <Link to="/home/rooms">rooms</Link>
                                </li>
                                <li className={this.isActive('playlists') ? 'active' : null} onClick={this.toggleClass.bind(this, 2)}>
                                    <Link to="/home/playlists">playlists</Link>
                                </li>
                                <li className={this.isActive('users') ? 'active' : null} onClick={this.toggleClass.bind(this, 3)}>
